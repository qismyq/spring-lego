package com.springlego.autoconfigure.user.convert.auth;
...
import com.springlego.autoconfigure.user.dto.vo.auth.AuthLoginRespVO;
...
import static com.springlego.autoconfigure.common.util.CollectionUtils.filterList;
...
//    AuthLoginRespVO convert(OAuth2AccessTokenDO bean);
    ...
    default AuthPermissionInfoRespVO convert(UserAccountDO user, List<RoleDO> roleList, List<MenuDO> menuList) {

...
import com.springlego.autoconfigure.user.mapper.DeptMapper;
import com.springlego.autoconfigure.user.service.IDeptService;
...
public class DeptServiceImpl implements IDeptService {
    ...
    public void deleteDept(Long id) {
        ...
        if (deptMapper.selectCountByParentId(id) > 0) {
            throw new ErrorMessageException(UserErrorCodeEnum.DEPT_EXITS_CHILDREN);
        }
        // 删除部门
    ...
    void validateDeptExists(Long id) {
        ...
        if (dept == null) {
            throw new ErrorMessageException(UserErrorCodeEnum.DEPT_NOT_FOUND);
        }
    }
    ...
    void validateParentDept(Long id, Long parentId) {
        ...
        if (Objects.equals(id, parentId)) {
            throw new ErrorMessageException(UserErrorCodeEnum.DEPT_PARENT_ERROR);
        }
        // 2. 父部门不存在
        DeptDO parentDept = deptMapper.selectById(parentId);
        if (parentDept == null) {
            throw new ErrorMessageException(UserErrorCodeEnum.DEPT_PARENT_NOT_EXITS);
        }
        ...
        for (int i = 0; i < Short.MAX_VALUE; i++) {
            ...
            if (Objects.equals(id, parentId)) {
                throw new ErrorMessageException(UserErrorCodeEnum.DEPT_PARENT_IS_CHILD);
            }
            // 3.2 继续递归下一级父部门
            if (parentId == null || DeptDO.PARENT_ID_ROOT.equals(parentId)) {
                break;
    ...
    void validateDeptNameUnique(Long id, Long parentId, String name) {
        ...
        if (id == null) {
            throw new ErrorMessageException(UserErrorCodeEnum.MULTIPLE_DEPT_NAME);
        }
    ...
    public void validateDeptList(Collection<Long> ids) {
        ...
        ids.forEach(id -> {
            ...
            if (!CommonStatusEnum.ENABLE.getStatus().equals(dept.getStatus())) {
                throw new ErrorMessageException(UserErrorCodeEnum.DEPT_NOT_ENABLE);
            }
        });
    }
